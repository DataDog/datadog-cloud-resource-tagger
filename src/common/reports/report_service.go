...
func (r *ReportService) PrintToStdout() {
	...
	fmt.Println("Scanned Resources:\t", r.report.Summary.Scanned)
	fmt.Println("New Resources Traced: \t", r.report.Summary.NewResources)
	fmt.Println("Updated Resources:\t", r.report.Summary.UpdatedResources)
	fmt.Println()
